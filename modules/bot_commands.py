...
async def send_msg_photo(chat_id: int, photo: types.InputFile, text: str,
                         markup: types.InlineKeyboardMarkup = empty_markups, **kwargs):
    """Отправка фото"""
...
async def edit_msg_text(text: str, chat_id: int, msg_id: int, markup: types.InlineKeyboardMarkup = empty_markups,
                        **kwargs):
...
async def edit_msg_caption(text: str, chat_id: int, msg_id: int, markup: types.InlineKeyboardMarkup = empty_markups,
                           **kwargs):
...
async def edit_msg_media(chat_id: int, msg_id: int, markup: types.InlineKeyboardMarkup = empty_markups,
                         file: InputMediaPhoto | None = None, file_id: str = ''):
    if file is None:
...
async def edit_msg_any(text: str, chat_id: int, msg_id: int, markup: types.InlineKeyboardMarkup = empty_markups,
                       **kwargs):
